    ...
    >
      ...
      {watermarkType === 'image' && (
        <div className="flex flex-col gap-4 mb-6">
          <div>
            <label className="block mb-1 text-sm" style={{ color: 'var(--color-text-primary)' }}>水印图片</label>
            <button
      ...
      {watermarkType === 'text' && (
        <div className="flex flex-col gap-4 mb-6">
          <div>
            <label className="block mb-1 text-sm" style={{ color: 'var(--color-text-primary)' }}>水印文字</label>
            <input
              type="text"
              value={text}
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="block mb-1 text-sm" style={{ color: 'var(--color-text-primary)' }}>字号</label>
            ...
            <div className="flex-1">
              <label className="block mb-1 text-sm" style={{ color: 'var(--color-text-primary)' }}>颜色</label>
      ...
      {/* 位置选择 — 九宫格 */}
      <div className="mb-4">
        <label className="block mb-2 font-medium text-sm" style={{ color: 'var(--color-text-primary)' }}>位置</label>
      ...
      <div className="flex gap-4">
        <div className="flex-1">
          <label className="block mb-1 text-xs" style={{ color: 'var(--color-text-secondary)' }}>X 偏移 (px)</label>
        ...
        <div className="flex-1">
          <label className="block mb-1 text-xs" style={{ color: 'var(--color-text-secondary)' }}>Y 偏移 (px)</label>
